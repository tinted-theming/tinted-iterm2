...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 23130, 24929}
        set ANSI bright green color to {39321, 55512, 41120}
        set ANSI bright yellow color to {65535, 56797, 32896}
        set ANSI bright blue color to {19789, 42662, 65535}
        set ANSI bright magenta color to {41891, 26214, 65535}
